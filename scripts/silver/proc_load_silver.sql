...
Script Purpose:
  ...
  populate the 'silver' schema tables fom the 'Bronze' schema.
Actions Performed:
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			SUBSTRING(prd_key, 7, LEN (prd_key)) AS prd_key_type,
			prd_nm,
	...
	BEGIN CATCH
		...
		PRINT 'ERROR PROCEDURE: ' + CAST(ERROR_LINE() AS NVARCHAR);
		PRINT '===========================================================================================';
	END CATCH
END;
GO

-- Loaded Completely the Silver Layer
EXEC silver.load_silver;
